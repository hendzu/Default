...
<?php
    $sql ="Select row_number(), kandidaadid.Nimi, parteid.Nimi, piirkonnad.Piirkond, count(*)
    ...
    echo "<table>";
    echo "<tr><th>Koht</th><th>Kandidaat</th><th>Partei</th><th>Piirkond</th><th>Hääled</th></tr>";
    foreach ($conn->query($sql) as $row) {
